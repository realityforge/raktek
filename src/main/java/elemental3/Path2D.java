 ...
 * @see <a href="https://html.spec.whatwg.org/multipage/#path2d-objects">The definition of 'Path2D' in the 'HTML Living Standard' specification.</a>
 */
...
public class Path2D {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/scripting.html#dom-path2d-addpath">The definition of 'Path2D.addPath()' in the 'HTML Living Standard' specification.</a>
   */
