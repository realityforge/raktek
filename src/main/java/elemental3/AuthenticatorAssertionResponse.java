 ...
 * @see <a href="https://w3c.github.io/webauthn/#iface-authenticatorassertionresponse">The definition of 'AuthenticatorAssertionResponse interface' in the 'Web Authentication: An API for accessing Public Key Credentials Level 1' specification.</a>
 */
...
public class AuthenticatorAssertionResponse extends AuthenticatorResponse {
   ...
   * @see <a href="https://w3c.github.io/webauthn/#dom-authenticatorassertionresponse-authenticatordata">The definition of 'authenticatorData' in the 'Web Authentication: An API for accessing Public Key Credentials Level 1' specification.</a>
   */
  @JsProperty(
   ...
   * @see <a href="https://w3c.github.io/webauthn/#dom-authenticatorassertionresponse-signature">The definition of 'signature' in the 'Web Authentication: An API for accessing Public Key Credentials Level 1' specification.</a>
   */
  @JsProperty(
      name = "signature"
  )
   ...
   * @see <a href="https://w3c.github.io/webauthn/#dom-authenticatorassertionresponse-userhandle">The definition of 'userHandle' in the 'Web Authentication: An API for accessing Public Key Credentials Level 1' specification.</a>
   */
  @JsProperty(
      name = "userHandle"
  )
