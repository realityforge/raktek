 ...
 * @see <a href="https://html.spec.whatwg.org/multipage/form-control-infrastructure.html#the-formdataevent-interface">The definition of 'FormDataEvent' in the 'HTML Living Standard' specification.</a>
 */
...
public class FormDataEvent extends Event {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-formdataevent-formdata">The definition of 'formData' in the 'HTML Living Standard' specification.</a>
   */
  @JsProperty(
      name = "formData"
  )
