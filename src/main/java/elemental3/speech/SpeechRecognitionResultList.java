 ...
 * @see <a href="https://wicg.github.io/speech-api/#speechreco-resultlist">The definition of 'SpeechRecognitionResultList' in the 'Web Speech API' specification.</a>
 */
...
public class SpeechRecognitionResultList {
   ...
   * @see <a href="https://wicg.github.io/speech-api/#dom-speechrecognitionresultlist-length">The definition of 'length' in the 'Web Speech API' specification.</a>
   */
  @JsProperty(
      name = "length"
  )
   ...
   * @see <a href="https://wicg.github.io/speech-api/#dom-speechrecognitionresultlist-item">The definition of 'item()' in the 'Web Speech API' specification.</a>
   */
  @Nonnull
