 ...
 * @see <a href="https://w3c.github.io/deviceorientation/#devicemotioneventacceleration">The definition of 'DeviceMotionEventAcceleration' in the 'DeviceOrientation Event Specification' specification.</a>
 */
...
public class DeviceMotionEventAcceleration {
   ...
   * @see <a href="https://w3c.github.io/deviceorientation/#dom-devicemotioneventacceleration-x">The definition of 'DeviceMotionEventAcceleration: x' in the 'DeviceOrientation Event Specification' specification.</a>
   */
  @JsProperty(
      name = "x"
  )
   ...
   * @see <a href="https://w3c.github.io/deviceorientation/#dom-devicemotioneventacceleration-y">The definition of 'DeviceMotionEventAcceleration: y' in the 'DeviceOrientation Event Specification' specification.</a>
   */
  @JsProperty(
      name = "y"
  )
   ...
   * @see <a href="https://w3c.github.io/deviceorientation/#dom-devicemotioneventacceleration-z">The definition of 'DeviceMotionEventAcceleration: z' in the 'DeviceOrientation Event Specification' specification.</a>
   */
  @JsProperty(
      name = "z"
  )
