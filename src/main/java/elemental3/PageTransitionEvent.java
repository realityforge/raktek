 ...
 * @see <a href="https://html.spec.whatwg.org/multipage/#the-pagetransitionevent-interface">The definition of 'PageTransitionEvent' in the 'HTML Living Standard' specification.</a>
 */
...
public class PageTransitionEvent extends Event {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-pagetransitionevent-persisted">The definition of 'PageTransitionEvent: persisted' in the 'HTML Living Standard' specification.</a>
   */
  @JsProperty(
      name = "persisted"
  )
