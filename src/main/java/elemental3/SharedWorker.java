 ...
 * @see <a href="https://html.spec.whatwg.org/multipage/#sharedworker">The definition of 'SharedWorker' in the 'HTML Living Standard' specification.</a>
 */
...
public class SharedWorker extends EventTarget {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-sharedworker">The definition of 'SharedWorker()' in the 'HTML Living Standard' specification.</a>
   */
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-sharedworker-port">The definition of 'AbstractWorker.onerror' in the 'HTML Living Standard' specification.</a>
   */
  @JsProperty(
      name = "port"
  )
