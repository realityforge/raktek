 ...
 * @see <a href="https://w3c.github.io/webauthn/#iface-pkcredential">The definition of 'PublicKeyCredential interface' in the 'Web Authentication: An API for accessing Public Key Credentials Level 1' specification.</a>
 */
...
public class PublicKeyCredential extends Credential {
   ...
   * @see <a href="https://w3c.github.io/webauthn/#dom-publickeycredential-rawid">The definition of 'rawId' in the 'Web Authentication: An API for accessing Public Key Credentials Level 1' specification.</a>
   */
  @JsProperty(
      name = "rawId"
  )
   ...
   * @see <a href="https://w3c.github.io/webauthn/#dom-publickeycredential-response">The definition of 'response' in the 'Web Authentication: An API for accessing Public Key Credentials Level 1' specification.</a>
   */
  @JsProperty(
      name = "response"
  )
   ...
   * @see <a href="https://w3c.github.io/webauthn/#dom-publickeycredential-getclientextensionresults">The definition of 'getClientExtensionResults()' in the 'Web Authentication: An API for accessing Public Key Credentials Level 1' specification.</a>
   */
  @Nonnull
   ...
   * @see <a href="https://w3c.github.io/webauthn/#dom-publickeycredential-isuserverifyingplatformauthenticatoravailable">The definition of 'isUserVerifyingPlatformAuthenticatorAvailable' in the 'Web Authentication: An API for accessing Public Key Credentials Level 1' specification.</a>
   */
  @Nonnull
