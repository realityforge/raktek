 ...
 * @see <a href="https://w3c.github.io/webauthn/#authenticatorattestationresponse">The definition of 'AuthenticatorAttestationResponse interface' in the 'Web Authentication: An API for accessing Public Key Credentials Level 1' specification.</a>
 */
...
public class AuthenticatorAttestationResponse extends AuthenticatorResponse {
   ...
   * @see <a href="https://w3c.github.io/webauthn/#dom-authenticatorattestationresponse-attestationobject">The definition of 'attestationObject' in the 'Web Authentication: An API for accessing Public Key Credentials Level 1' specification.</a>
   */
  @JsProperty(
