 ...
 * @see <a href="https://w3c.github.io/webauthn/#authenticatorresponse">The definition of 'AuthenticatorResponse interface' in the 'Web Authentication: An API for accessing Public Key Credentials Level 1' specification.</a>
 */
...
public class AuthenticatorResponse {
   ...
   * @see <a href="https://w3c.github.io/webauthn/#dom-authenticatorresponse-clientdatajson">The definition of 'clientDataJSON' in the 'Web Authentication: An API for accessing Public Key Credentials Level 1' specification.</a>
   */
  @JsProperty(
      name = "clientDataJSON"
  )
