 ...
 * @see <a href="https://immersive-web.github.io/webxr/#xrreferencespace-interface">The definition of 'XRReferenceSpace' in the 'WebXR Device API' specification.</a>
 */
...
public class XRReferenceSpace extends XRSpace {
   ...
   * @see <a href="https://immersive-web.github.io/webxr/#dom-xrreferencespace-onreset">The definition of 'onreset' in the 'WebXR Device API' specification.</a>
   */
  @Nullable
   ...
   * @see <a href="https://immersive-web.github.io/webxr/#dom-xrreferencespace-getoffsetreferencespace">The definition of 'getOffsetReferenceSpace()' in the 'WebXR Device API' specification.</a>
   */
  @Nonnull
