 ...
 * @see <a href="https://immersive-web.github.io/webxr/#xrinputsourceevent">The definition of 'XRInputSourceEvent' in the 'WebXR Device API' specification.</a>
 */
...
public class XRInputSourceEvent extends Event {
   ...
   * @see <a href="https://immersive-web.github.io/webxr/#dom-xrinputsourceevent-frame">The definition of 'XRInputSourceEvent.frame' in the 'WebXR Device API' specification.</a>
   */
  @JsProperty(
      name = "frame"
  )
   ...
   * @see <a href="https://immersive-web.github.io/webxr/#dom-xrinputsourceevent-inputsource">The definition of 'XRInputSourceEvent.inputSource' in the 'WebXR Device API' specification.</a>
   */
  @JsProperty(
      name = "inputSource"
  )
