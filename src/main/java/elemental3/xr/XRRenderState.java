 ...
 * @see <a href="https://immersive-web.github.io/webxr/#xrrenderstate-interface">The definition of 'XRRenderState' in the 'WebXR Device API' specification.</a>
 */
...
public class XRRenderState {
   ...
   * @see <a href="https://immersive-web.github.io/webxr/#dom-xrrenderstate-baselayer">The definition of 'XRRenderState.baseLayer' in the 'WebXR Device API' specification.</a>
   */
  @JsProperty(
      name = "baseLayer"
  )
   ...
   * @see <a href="https://immersive-web.github.io/webxr/#dom-xrrenderstate-inlineVerticalFieldOfView">The definition of 'XRRenderState.inlineVerticalFieldOfView' in the 'WebXR Device API' specification.</a>
   */
  @JsProperty(
