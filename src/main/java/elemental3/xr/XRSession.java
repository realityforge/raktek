 ...
 * @see <a href="https://immersive-web.github.io/webxr/#xrsession-interface">The definition of 'XRSession' in the 'WebXR Device API' specification.</a>
 */
...
public class XRSession extends EventTarget {
   ...
   * @see <a href="https://immersive-web.github.io/webxr/#dom-xrsession-inputsources">The definition of 'XRSession.inputSources' in the 'WebXR Device API' specification.</a>
   */
  @JsProperty(
      name = "inputSources"
  )
   ...
   * @see <a href="https://immersive-web.github.io/webxr/#dom-xrsession-renderstate">The definition of 'XRSession.renderState' in the 'WebXR Device API' specification.</a>
   */
  @JsProperty(
      name = "renderState"
  )
   ...
   * @see <a href="https://immersive-web.github.io/webxr/#dom-xrsession-visibilitystate">The definition of 'XRSession.visibilityState' in the 'WebXR Device API' specification.</a>
   */
  @JsProperty(
   ...
   * @see <a href="https://immersive-web.github.io/webxr/#dom-xrsession-cancelanimationframe">The definition of 'XRSession.cancelAnimationFrame' in the 'WebXR Device API' specification.</a>
   */
   ...
   * @see <a href="https://immersive-web.github.io/webxr/#dom-xrsession-end">The definition of 'XRSession.end' in the 'WebXR Device API' specification.</a>
   */
  @Nonnull
   ...
   * @see <a href="https://immersive-web.github.io/webxr/#dom-xrsession-requestanimationframe">The definition of 'XRSession.requestAnimationFrame' in the 'WebXR Device API' specification.</a>
   */
   ...
   * @see <a href="https://immersive-web.github.io/webxr/#dom-xrsession-requestreferencespace">The definition of 'requestReferenceSpace()' in the 'WebXR Device API' specification.</a>
   */
  @Nonnull
   ...
   * @see <a href="https://immersive-web.github.io/webxr/#dom-xrsession-updaterenderstate">The definition of 'XRSession.updateRenderState()' in the 'WebXR Device API' specification.</a>
   */
