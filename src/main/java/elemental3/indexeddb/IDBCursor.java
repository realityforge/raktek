 ...
 * @see <a href="https://www.w3.org/TR/IndexedDB/#cursor-interface">The definition of 'cursor' in the 'Indexed Database API 2.0' specification.</a>
 * @see <a href="https://w3c.github.io/IndexedDB/#cursor-interface">The definition of 'cursor' in the 'Indexed Database API Draft' specification.</a>
 */
...
public class IDBCursor {
   ...
   * @see <a href="https://www.w3.org/TR/IndexedDB/#dom-idbcursor-direction">The definition of 'direction' in the 'Indexed Database API 2.0' specification.</a>
   * @see <a href="https://w3c.github.io/IndexedDB/#dom-idbcursor-direction">The definition of 'direction' in the 'Indexed Database API Draft' specification.</a>
   */
  @JsProperty(
      name = "direction"
  )
   ...
   * @see <a href="https://www.w3.org/TR/IndexedDB/#dom-idbcursor-key">The definition of 'key' in the 'Indexed Database API 2.0' specification.</a>
   * @see <a href="https://w3c.github.io/IndexedDB/#dom-idbcursor-key">The definition of 'key' in the 'Indexed Database API Draft' specification.</a>
   */
  @JsProperty(
      name = "key"
  )
   ...
   * @see <a href="https://www.w3.org/TR/IndexedDB/#dom-idbcursor-primarykey">The definition of 'primaryKey' in the 'Indexed Database API 2.0' specification.</a>
   * @see <a href="https://w3c.github.io/IndexedDB/#dom-idbcursor-primarykey">The definition of 'primaryKey' in the 'Indexed Database API Draft' specification.</a>
   */
  @JsProperty(
      name = "primaryKey"
  )
   ...
   * @see <a href="https://w3c.github.io/IndexedDB/#dom-idbcursor-source">The definition of 'source' in the 'Indexed Database API Draft' specification.</a>
   */
  @JsProperty(
      name = "source"
  )
   ...
   * @see <a href="https://www.w3.org/TR/IndexedDB/#dom-idbcursor-advance">The definition of 'advance()' in the 'Indexed Database API 2.0' specification.</a>
   * @see <a href="https://w3c.github.io/IndexedDB/#dom-idbcursor-advance">The definition of 'advance()' in the 'Indexed Database API Draft' specification.</a>
   */
   ...
   * @see <a href="https://w3c.github.io/IndexedDB/#dom-idbcursor-continueprimarykey">The definition of 'continuePrimaryKey()' in the 'Indexed Database API Draft' specification.</a>
   */
   ...
   * @see <a href="https://www.w3.org/TR/IndexedDB/#dom-idbcursor-delete">The definition of 'delete()' in the 'Indexed Database API 2.0' specification.</a>
   * @see <a href="https://w3c.github.io/IndexedDB/#dom-idbcursor-delete">The definition of 'delete()' in the 'Indexed Database API Draft' specification.</a>
   */
  @Nonnull
   ...
   * @see <a href="https://www.w3.org/TR/IndexedDB/#dom-idbcursor-update">The definition of 'update()' in the 'Indexed Database API 2.0' specification.</a>
   * @see <a href="https://w3c.github.io/IndexedDB/#dom-idbcursor-update">The definition of 'update()' in the 'Indexed Database API Draft' specification.</a>
   */
  @Nonnull
