 ...
 * @see <a href="https://html.spec.whatwg.org/multipage/#worker">The definition of 'Worker' in the 'HTML Living Standard' specification.</a>
 */
...
public class Worker extends EventTarget {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#handler-abstractworker-onerror">The definition of 'AbstractWorker.onerror' in the 'HTML Living Standard' specification.</a>
   */
  @Nullable
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#handler-worker-onmessage">The definition of 'Worker.onmessage' in the 'HTML Living Standard' specification.</a>
   */
  @Nullable
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#handler-worker-onmessageerror">The definition of 'onmessageerror' in the 'HTML Living Standard' specification.</a>
   */
  @Nullable
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-worker">The definition of 'Worker()' in the 'HTML Living Standard' specification.</a>
   */
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-worker-postmessage">The definition of 'Worker.postMessage()' in the 'HTML Living Standard' specification.</a>
   */
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-worker-terminate">The definition of 'Worker.terminate()' in the 'HTML Living Standard' specification.</a>
   */
