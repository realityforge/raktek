 ...
 * @see <a href="https://storage.spec.whatwg.org/#dictdef-storageestimate">The definition of 'StorageEstimate' in the 'Storage' specification.</a>
 */
...
public interface StorageEstimate {
   ...
   * @see <a href="https://storage.spec.whatwg.org/#dom-storageestimate-quota">The definition of 'quota' in the 'Storage' specification.</a>
   */
  @JsProperty(
      name = "quota"
  )
   ...
   * @see <a href="https://storage.spec.whatwg.org/#dom-storageestimate-usage">The definition of 'usage' in the 'Storage' specification.</a>
   */
  @JsProperty(
      name = "usage"
  )
