 ...
 * @see <a href="https://w3c.github.io/webrtc-pc/#rtcrtptransceiver-interface">The definition of 'RTCRtpTransceiver' in the 'WebRTC 1.0: Real-time Communication Between Browsers' specification.</a>
 */
...
public class RTCRtpTransceiver {
   ...
   * @see <a href="https://w3c.github.io/webrtc-pc/#dom-rtcrtptransceiver-direction">The definition of 'RTCRtpTransceiver.direction' in the 'WebRTC 1.0: Real-time Communication Between Browsers' specification.</a>
   */
  @Nonnull
   ...
   * @see <a href="https://w3c.github.io/webrtc-pc/#dom-rtcrtptransceiver-currentdirection">The definition of 'RTCRtpTransceiver.currentDirection' in the 'WebRTC 1.0: Real-time Communication Between Browsers' specification.</a>
   */
  @JsProperty(
   ...
   * @see <a href="https://w3c.github.io/webrtc-pc/#dom-rtptransceiver-mid">The definition of 'RTCRtpTransceiver.mid' in the 'WebRTC 1.0: Real-time Communication Between Browsers' specification.</a>
   */
  @JsProperty(
      name = "mid"
  )
   ...
   * @see <a href="https://w3c.github.io/webrtc-pc/#dom-rtcrtptransceiver-receiver">The definition of 'RTCRtpTransceiver.receiver' in the 'WebRTC 1.0: Real-time Communication Between Browsers' specification.</a>
   */
  @JsProperty(
      name = "receiver"
  )
   ...
   * @see <a href="https://w3c.github.io/webrtc-pc/#dom-rtcrtptransceiver-sender">The definition of 'RTCRtpTransceiver.sender' in the 'WebRTC 1.0: Real-time Communication Between Browsers' specification.</a>
   */
  @JsProperty(
      name = "sender"
  )
   ...
   * @see <a href="https://w3c.github.io/webrtc-pc/#dom-rtcrtptransceiver-setcodecpreferences">The definition of 'RTCRtpTransceiver.setCodecPreferences()' in the 'WebRTC 1.0: Real-time Communication Between Browsers' specification.</a>
   */
   ...
   * @see <a href="https://w3c.github.io/webrtc-pc/#dom-rtcrtptransceiver-stop">The definition of 'RTCRtpTransceiver.stop()' in the 'WebRTC 1.0: Real-time Communication Between Browsers' specification.</a>
   */
