...
public @interface TexelDataType {
  final class Validator {
    ...
    public static String describe(final int value) {
      return WebGL2RenderingContext.UNSIGNED_BYTE == value ? "UNSIGNED_BYTE" : WebGL2RenderingContext.UNSIGNED_SHORT == value ? "UNSIGNED_SHORT" : WebGL2RenderingContext.UNSIGNED_SHORT_5_6_5 == value ? "UNSIGNED_SHORT_5_6_5" : WebGL2RenderingContext.UNSIGNED_SHORT_4_4_4_4 == value ? "UNSIGNED_SHORT_4_4_4_4" : WebGL2RenderingContext.UNSIGNED_SHORT_5_5_5_1 == value ? "UNSIGNED_SHORT_5_5_5_1" : WebGL2RenderingContext.BYTE == value ? "BYTE" : WebGL2RenderingContext.SHORT == value ? "SHORT" : WebGL2RenderingContext.UNSIGNED_INT == value ? "UNSIGNED_INT" : WEBGL_depth_texture.UNSIGNED_INT_24_8_WEBGL == value ? "UNSIGNED_INT_24_8_WEBGL" : WebGL2RenderingContext.INT == value ? "INT" : WebGL2RenderingContext.HALF_FLOAT == value ? "HALF_FLOAT" : OES_texture_half_float.HALF_FLOAT_OES == value ? "HALF_FLOAT_OES" : WebGL2RenderingContext.FLOAT == value ? "FLOAT" : WebGL2RenderingContext.UNSIGNED_INT_2_10_10_10_REV == value ? "UNSIGNED_INT_2_10_10_10_REV" : WebGL2RenderingContext.UNSIGNED_INT_10F_11F_11F_REV == value ? "UNSIGNED_INT_10F_11F_11F_REV" : WebGL2RenderingContext.UNSIGNED_INT_5_9_9_9_REV == value ? "UNSIGNED_INT_5_9_9_9_REV" : WebGL2RenderingContext.UNSIGNED_INT_24_8 == value ? "UNSIGNED_INT_24_8" : WebGL2RenderingContext.FLOAT_32_UNSIGNED_INT_24_8_REV == value ? "FLOAT_32_UNSIGNED_INT_24_8_REV" : "Unknown value " + value;
    }
  }
}
