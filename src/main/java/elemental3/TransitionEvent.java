 ...
 * @see <a href="https://drafts.csswg.org/css-transitions/#interface-transitionevent">The definition of 'TransitionEvent' in the 'CSS Transitions' specification.</a>
 */
...
public class TransitionEvent extends Event {
   ...
   * @see <a href="https://drafts.csswg.org/css-transitions/#dom-transitionevent-transitionevent">The definition of 'TransitionEvent()' in the 'CSS Transitions' specification.</a>
   */
   ...
   * @see <a href="https://drafts.csswg.org/css-transitions/#Events-TransitionEvent-elapsedTime">The definition of 'TransitionEvent.elapsedTime' in the 'CSS Transitions' specification.</a>
   */
  @JsProperty(
      name = "elapsedTime"
  )
   ...
   * @see <a href="https://drafts.csswg.org/css-transitions/#Events-TransitionEvent-pseudoElement">The definition of 'TransitionEvent.pseudoElement' in the 'CSS Transitions' specification.</a>
   */
  @JsProperty(
      name = "pseudoElement"
  )
