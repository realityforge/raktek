 ...
 * @see <a href="https://html.spec.whatwg.org/multipage/#htmlvideoelement">The definition of 'HTMLVideoElement' in the 'HTML Living Standard' specification.</a>
 */
...
public class HTMLVideoElement extends HTMLMediaElement implements TexImageSource {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-video-videoheight">The definition of 'HTMLVideoElement.videoHeight' in the 'HTML Living Standard' specification.</a>
   * @see <a href="https://www.w3.org/TR/html52/semantics-embedded-content.html#dom-htmlvideoelement-videoheight">The definition of 'HTMLVideoElement.videoHeight' in the 'HTML5' specification.</a>
   */
  @JsProperty(
      name = "videoHeight"
  )
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/#dom-video-videowidth">The definition of 'HTMLVideoElement.videoWidth' in the 'HTML Living Standard' specification.</a>
   * @see <a href="https://www.w3.org/TR/html52/semantics-embedded-content.html#dom-htmlvideoelement-videowidth">The definition of 'HTMLVideoElement.videoWidth' in the 'HTML5' specification.</a>
   */
  @JsProperty(
      name = "videoWidth"
  )
   ...
   * @see <a href="https://w3c.github.io/media-playback-quality/#dom-htmlvideoelement-getvideoplaybackquality">The definition of 'HTMLVideoElement.getVideoPlaybackQuality()' in the 'Media Playback Quality' specification.</a>
   */
  @Nonnull
