 ...
 * @see <a href="https://html.spec.whatwg.org/multipage/web-messaging.html#message-channels">The definition of 'Message channels' in the 'HTML Living Standard' specification.</a>
 */
...
public class MessageChannel {
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/web-messaging.html#dom-messagechannel">The definition of 'MessageChannel()' in the 'HTML Living Standard' specification.</a>
   */
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/web-messaging.html#dom-messagechannel-port1">The definition of 'port1' in the 'HTML Living Standard' specification.</a>
   */
  @JsProperty(
      name = "port1"
  )
   ...
   * @see <a href="https://html.spec.whatwg.org/multipage/web-messaging.html#dom-messagechannel-port2">The definition of 'port2' in the 'HTML Living Standard' specification.</a>
   */
  @JsProperty(
      name = "port2"
  )
