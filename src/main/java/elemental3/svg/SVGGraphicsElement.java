 ...
 * @see <a href="https://svgwg.org/svg2-draft/types.html#InterfaceSVGGraphicsElement">The definition of 'SVGGraphicsElement' in the 'Scalable Vector Graphics (SVG) 2' specification.</a>
 */
...
public class SVGGraphicsElement extends SVGElement {
   ...
   * @see <a href="https://www.w3.org/TR/SVG11/types.html#__svg__SVGLocatable__getBBox">The definition of 'getBBox' in the 'Scalable Vector Graphics (SVG) 1.1 (Second Edition)' specification.</a>
   */
  @Nonnull
