...
public class SVGAElement extends SVGGraphicsElement {
   ...
   * @see <a href="https://www.w3.org/TR/SVG11/linking.html#InterfaceSVGAElement">The definition of 'target' in the 'Scalable Vector Graphics (SVG) 1.1 (Second Edition)' specification.</a>
   */
  @JsProperty(
      name = "target"
  )
