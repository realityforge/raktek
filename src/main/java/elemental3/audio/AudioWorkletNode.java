 ...
 * @see <a href="https://webaudio.github.io/web-audio-api/#audioworkletnode">The definition of 'AudioWorkletNode' in the 'Web Audio API' specification.</a>
 */
...
public class AudioWorkletNode extends AudioNode {
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-audioworkletnode-onprocessorerror">The definition of 'onprocessorerror' in the 'Web Audio API' specification.</a>
   */
  @Nullable
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-audioworkletnode-audioworkletnode">The definition of 'AudioWorkletNode()' in the 'Web Audio API' specification.</a>
   */
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-audioworkletnode-parameters">The definition of 'parameters' in the 'Web Audio API' specification.</a>
   */
  @JsProperty(
      name = "parameters"
  )
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-audioworkletnode-port">The definition of 'port' in the 'Web Audio API' specification.</a>
   */
  @JsProperty(
      name = "port"
  )
