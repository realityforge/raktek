 ...
 * @see <a href="https://webaudio.github.io/web-audio-api/#oscillatornode">The definition of 'OscillatorNode' in the 'Web Audio API' specification.</a>
 */
...
public class OscillatorNode extends AudioScheduledSourceNode {
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-oscillatornode-type">The definition of 'type' in the 'Web Audio API' specification.</a>
   */
  @Nonnull
  @OscillatorType
  public String type;
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-oscillatornode-oscillatornode">The definition of 'OscillatorNode()' in the 'Web Audio API' specification.</a>
   */
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-oscillatornode-detune">The definition of 'detune' in the 'Web Audio API' specification.</a>
   */
  @JsProperty(
      name = "detune"
  )
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-oscillatornode-frequency">The definition of 'frequency' in the 'Web Audio API' specification.</a>
   */
  @JsProperty(
      name = "frequency"
  )
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-oscillatornode-setperiodicwave">The definition of 'setPeriodicWave' in the 'Web Audio API' specification.</a>
   */
