...
public class MediaStreamAudioSourceNode extends AudioNode {
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-mediastreamaudiosourcenode-mediastreamaudiosourcenode">The definition of 'MediaStreamAudioSourceNode()' in the 'Web Audio API' specification.</a>
   */
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-mediastreamaudiosourcenode-mediastream">The definition of 'MediaStreamAudioSourceNode.mediaStream' in the 'Web Audio API' specification.</a>
   */
  @JsProperty(
      name = "mediaStream"
  )
