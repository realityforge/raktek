 ...
 * @see <a href="https://webaudio.github.io/web-audio-api/#gainnode">The definition of 'GainNode' in the 'Web Audio API' specification.</a>
 */
...
public class GainNode extends AudioNode {
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-gainnode-gainnode">The definition of 'GainNode()' in the 'Web Audio API' specification.</a>
   */
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-gainnode-gain">The definition of 'gain' in the 'Web Audio API' specification.</a>
   */
  @JsProperty(
      name = "gain"
  )
