...
public class ConstantSourceNode extends AudioScheduledSourceNode {
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-constantsourcenode-constantsourcenode">The definition of 'ConstantSourceNode: ConstantSourceNode' in the 'Web Audio API' specification.</a>
   */
   ...
   * @see <a href="https://webaudio.github.io/web-audio-api/#dom-constantsourcenode-offset">The definition of 'offset' in the 'Web Audio API' specification.</a>
   */
  @JsProperty(
      name = "offset"
  )
